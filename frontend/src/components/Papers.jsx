  ...
  return (
    <div>
      ...
      <main className="w-[60vw] m-auto flex flex-col justify-center items-center gap-2">
        {posts.length === 0 ? <div className="w-full h-[100vh] font-extrabold text-3xl flex justify-center items-center text-center">Notinhg is Avilable Now </div> : posts.map((post) => (
